...
class KlubCzytelnika implements Obserwator, Serializable {
    ...
    public static void main(String[] args) {
        ...
        if (plik.exists()) {
            ...
            try (ObjectInputStream in = new ObjectInputStream(new FileInputStream(plik))) {
                ...
                System.out.println("Wczytani pisarze:");
                for (Pisarz p : dane.pisarze)
                    System.out.println(p);

                System.out.println("Wczytane książki:");
                for (Ksiazka k : dane.ksiazki)
                    System.out.println(k);

                System.out.println("Wczytani obserwatorzy:");
                for (Obserwator o : dane.czytelnik)
